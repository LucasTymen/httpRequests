...
the first console.log lauched immediately and the rest of the text took several seconds to display (waiting for the counting to be over)
Our answer
...
with organising the heap with stacks in a LIFO without blocking the code execution with asynchronous methods.
Our answer
...
first, it organises the flow of functions in a LIFO order. then it helps with making alts on pending tasks, helping the code to keep on executing asynchronously untill the resolutions are completes.
Our answer
